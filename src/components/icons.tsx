...
export const Facebook = ({ className, height }: Icon) => (
   <svg
...
export const Github = ({ className, height }: Icon) => (
   <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      height={height}
...
export const Linkedin = ({ className, height }: Icon) => (
   <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      height={height}
...
export const Continental = ({ className, height }: Icon) => (
   <svg
      version="1.0"
      xmlns="http://www.w3.org/2000/svg"
      height={height}
...
export const Alura = ({ className, height }: Icon) => (
   <svg
      version="1.0"
      xmlns="http://www.w3.org/2000/svg"
      height={height}
